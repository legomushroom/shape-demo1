...
/***/ function(module, exports, __webpack_require__) {
	...
	var _greenScene = __webpack_require__(83);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _whiteTriangles = __webpack_require__(82);
	...
	var GreenScene = function (_Module) {
	  ...
	  */
	  ...
	  GreenScene.prototype._render = function _render() {
	    ...
	    var Trails = function (_mojs$CustomShape) {
	      (0, _inherits3.default)(Trails, _mojs$CustomShape);

	      function Trails() {
	        (0, _classCallCheck3.default)(this, Trails);
	        return (0, _possibleConstructorReturn3.default)(this, _mojs$CustomShape.apply(this, arguments));
	      }

	      Trails.prototype.getShape = function getShape() {
	    ...
	    var trails1 = new mojs.Shape((0, _extends3.default)({}, TRAIL_OPTS, {
	      left: '125%',
	      top: '25%',
	      angle: 80
	    }));

	    var trails2 = new mojs.Shape((0, _extends3.default)({}, TRAIL_OPTS, {
	      top: '125%',
	      left: '80%',
	      angle: 165
	    }));

	    var trails3 = new mojs.Shape((0, _extends3.default)({}, TRAIL_OPTS, {
	      top: '75%',
	      left: '-25%',
	      angle: 250
	    }));

	    var trails4 = new mojs.Shape((0, _extends3.default)({}, TRAIL_OPTS, {
	      top: '-25%',
	      left: '20%',
	      angle: 330
	    }));
	    ...
	    return timeline.add(pinkSquare, trails1, trails2, trails3, trails4);
	  };
